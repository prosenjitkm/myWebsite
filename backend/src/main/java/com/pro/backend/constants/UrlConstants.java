...
public final class UrlConstants {
    ...
    public static final class OAuth2 {
        ...
        /**
         * Path on the Angular SPA that receives the JWT token after OAuth2 login.
         * Combined with FRONTEND_URL env var: <FRONTEND_URL>/oauth2/callback?token=...
         */
        public static final String CALLBACK_PATH = "/oauth2/callback";
        /** @deprecated Use frontendUrl + CALLBACK_PATH instead (FRONTEND_URL env var) */
        @Deprecated
